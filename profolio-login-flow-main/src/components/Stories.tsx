  ...
  return (
    <>
      ...
      <Dialog open={!!selectedStoryGroup} onOpenChange={() => setSelectedStoryGroup(null)}>
        <DialogContent className="w-screen h-screen max-w-none p-0 bg-black border-none rounded-none flex items-center justify-center outline-none ring-0 z-[100] [&>button]:hidden">
          {currentStory && (
            <div 
              className="relative w-full h-full max-w-md mx-auto cursor-pointer flex flex-col justify-center"
