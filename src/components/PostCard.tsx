  ...
  return (
    <article 
      className="bg-card overflow-hidden
        ...
        sm:rounded-xl sm:border sm:border-border/50 sm:shadow-[0_1px_3px_rgba(0,0,0,0.08)] sm:hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-shadow duration-300" 
      id={`post-${id}`}
    >
      {/* Post Header */}
      <PostHeader
      ...
      {/* Post separator divider - Profolio style on mobile */}
      <div className="h-2 bg-muted/40 sm:hidden" />
