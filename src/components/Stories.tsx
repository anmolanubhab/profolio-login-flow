          ...
          <div className="flex flex-col items-center gap-2 min-w-[72px]">
            ...
            >
              ...
              <div className="absolute bottom-0 right-0 z-10">
                <div className="w-5 h-5 rounded-full bg-primary flex items-center justify-center border-[1.5px] border-background shadow-sm group-hover:scale-110 transition-transform">
