...
const SidebarProvider = React.forwardRef<HTMLDivElement, React.ComponentProps<"div"> & {
  ...
  return <SidebarContext.Provider value={contextValue}>
        ...
        ...style
      } as React.CSSProperties} className={cn("group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar px-[36px] pr-[16px] pl-[36px]", className)} ref={ref} {...props}>
            {children}
          </div>
        </TooltipProvider>
