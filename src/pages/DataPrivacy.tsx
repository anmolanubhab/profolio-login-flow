      ...
      <div className="space-y-8">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              <div className="flex items-start gap-4">
                ...
                />
                <div>
                  <h1 className="text-white text-3xl sm:text-4xl lg:text-5xl font-extrabold">Data Privacy</h1>
                  <p className="text-white/80 text-sm sm:text-base md:text-lg mt-2">Your Data. Your Control. Secure by Design.</p>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-2 sm:px-0">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
            <div className="bg-white/50 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-2xl transition p-6 border border-white/30">
              <div className="flex items-center justify-between">
          ...
          <div className="mt-10 relative rounded-2xl p-[2px] overflow-hidden"
            ...
            <div className="bg-white/50 backdrop-blur-xl rounded-2xl shadow-lg hover:shadow-2xl transition p-6 relative border border-white/30">
