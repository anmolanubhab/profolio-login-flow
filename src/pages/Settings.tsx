...
const Settings = () => {
  ...
  return (
      <div className="space-y-8">
        <div className="w-full rounded-3xl bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-500 py-10 px-6 sm:px-8 lg:px-10 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-2 sm:px-0">
          <div className="bg-white/50 backdrop-blur-xl border border-white/30 rounded-2xl shadow-lg p-6 flex items-center gap-4">
